 ...
 * necessary to add the class {@link cl.niclabs.adkintunmobile.commons.NicLabsApp} to
...
//	}
     ...
     * @return
     */
    public static <T extends SugarRecord<?>> Iterator<T> find(Class<T> type,
     ...
     * @return
     */
    public static <T extends cl.niclabs.adkintunmobile.commons.data.Persistent<?>> T findFirst(Class<T> type,
                                                                                String whereClause, String... whereArgs) {
    ...
    public List<Field> getTableFields() {
        ...
        for (Field field : typeFields) {
            ...
            if (!field.isAnnotationPresent(Ignore.class)
                    && !field.isAnnotationPresent(com.orm.dsl.Ignore.class)
                    && !ReflectionUtils.isListOf(cl.niclabs.adkintunmobile.commons.data.Persistent.class, field)
                    && !Modifier.isStatic(field.getModifiers())
                    && !Modifier.isTransient(field.getModifiers())) {
                toStore.add(field);
            }

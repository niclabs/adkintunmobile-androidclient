...
import cl.niclabs.adkintunmobile.commons.net.SntpClient;
...
public class Clock extends Service {
    ...
    private static final String TAG = "NicLabs::Clock";
    ...
    private boolean fromSharedPreferences() {
        SharedPreferences settings = getSharedPreferences(NicLabsApp.LIBRARY_SETTINGS, Context.MODE_PRIVATE);
    ...
    private void toSharedPreferences() {
        if (isSynchronized) {
            SharedPreferences.Editor editor = getSharedPreferences(NicLabsApp.LIBRARY_SETTINGS, Context.MODE_PRIVATE).edit();

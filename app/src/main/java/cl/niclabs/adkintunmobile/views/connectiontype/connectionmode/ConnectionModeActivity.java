...
public class ConnectionModeActivity extends ConnectionTypeActivity {
    ...
    public void showTutorial() {
        ...
        showcaseView = new ShowcaseView.Builder(this)
                ...
                .setContentTitle(getString(R.string.view_connection_mode_tutorial_1_title))
                .setContentText(getString(R.string.view_connection_mode_tutorial_1_body))
                    ...
                    public void onClick(View v) {
                        switch (helpCounter) {
                            case 0:
                                ...
                                showcaseView.setContentTitle(getString(R.string.view_connection_mode_tutorial_2_title));
                                showcaseView.setContentText(getString(R.string.view_connection_mode_tutorial_2_body));
                                break;
                            ...
                            case 1:
                                ...
                                showcaseView.setContentTitle(getString(R.string.view_connection_mode_tutorial_3_title));
                                showcaseView.setContentText(getString(R.string.view_connection_mode_tutorial_3_body));
                                break;

                            case 2:
                                Target mTarget2 = new ViewTarget(findViewById(R.id.menu_date_picker_btn));
                                showcaseView.setShowcase(mTarget2, true);
                                showcaseView.setContentTitle(getString(R.string.view_connection_mode_tutorial_4_title));
                                showcaseView.setContentText(getString(R.string.view_connection_mode_tutorial_4_body));

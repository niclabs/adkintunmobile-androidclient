package cl.niclabs.adkintunmobile.adkmobile.monitor;

import android.os.Binder;
import android.os.Bundle;
import cl.niclabs.adkintunmobile.adkmobile.AdkintunMobileApp;
 ...
 * @param <E>
 *            listeners that the monitor handles
 */
public interface Monitor<E extends MonitorListener> {
    ...
    /**
     * Extra key for communicating the activated/deactivated events to the
     * monitor
     */
     ...
     */
    public static final int CUSTOM_1 = 8192;
    public static final int CUSTOM_2 = 16384;
    public static final int CUSTOM_3 = 32768;
    public static final int CUSTOM_4 = 65536;
    public static final int CUSTOM_5 = 131072;
     ...
     * @param events
     * @param configuration
     *            additional configurations for the events
     * @return true if the event was activated correctly, false otherwise or if
     *         the event is not recongnized by the monitor
     */
     ...
     *
     * @param <E>
     *            the type of monitor for the service binder
     */
     ...
     *
     * A controller allows to specify actions to be performed upon binding of
     * the monitor.
     *
     * @author Felipe Lalanne <flalanne@niclabs.cl>
     *
    ...
    public static interface Controller<L extends MonitorListener> {
        /**
         * Activate the monitor upon binding. Successive calls to this method
         * must update the code of the event to activate and the internal
         * configuration
         *
         * @param events
         * @param configuration
         *            configuration for the event, can be null in which case is
         *            ignored
         */
        public void activate(int events, Bundle configuration);
        ...
        /**
         * Activate the monitor upon binding. Successive calls to this method
         * must update the code of the event to activate.
         *
         * @param events
         */
        public void activate(int events);

package cl.niclabs.adkintunmobile.adkmobile;
 ...
 *
 * <code>
 * <application android:label="@string/app_name" android:icon="@drawable/icon" android:name="cl.niclabs.adkintunmobile.adkmobile.AdkintunMobileApp">
